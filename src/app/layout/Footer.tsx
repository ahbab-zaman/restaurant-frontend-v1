...
function FooterLogo() {
  return (
    <Link
      href="/"
      className="flex items-center gap-2.5 group select-none w-fit"
    >
      <motion.div
...
function FooterAccordion({ group }: { group: LinkGroup }) {
  ...
  return (
    <div className="border-b border-border/40 last:border-b-0">
      <button
        onClick={() => setOpen((p) => !p)}
        className="flex w-full items-center justify-between py-4 text-sm font-semibold text-foreground tracking-wide"
      >
        {group.title}
        <motion.span
    ...
    <div className="grid grid-cols-3 gap-8">
      {linkGroups.map((group) => (
        <div key={group.title} className="flex flex-col gap-4">
          <h4 className="text-xs font-semibold tracking-widest uppercase text-foreground/50">
            {group.title}
          </h4>
    ...
    <footer className="border-t border-border/50 bg-nav-bg">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-14">
        ...
        <div className="md:hidden flex flex-col gap-8">
          ...
          {/* App download (simplified on mobile) */}
          <div className="flex flex-col gap-3">
            ...
            <div className="flex gap-3">
              ...
              <motion.a
                href="#"
                whileTap={{ scale: 0.97 }}
                className="flex items-center gap-2 px-3 py-2.5 rounded-lg border border-border/60 text-foreground/80"
              >
                <svg
                  width="12"
                  height="13"
                ...
                <div className="flex flex-col leading-none">
                  <span className="text-[9px] opacity-60">Download on</span>
                  <span className="text-xs font-semibold">App Store</span>
                </div>
              </motion.a>
            </div>
