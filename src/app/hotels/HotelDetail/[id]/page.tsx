...
export default function HotelDetailPage() {
  ...
  if (hotelsLoading || roomsLoading) {
    return (
      <div className="min-h-screen bg-[#f3f1ee] px-4 py-16 text-[#3b2f24] sm:px-6 lg:px-8">
  ...
  if (hotelsError || roomsError) {
    return (
      <div className="min-h-screen bg-[#f3f1ee] px-4 py-16 sm:px-6 lg:px-8">
  ...
  if (!hotel) {
    return (
      <div className="min-h-screen bg-[#f3f1ee] px-4 py-16 sm:px-6 lg:px-8">
        <div className="mx-auto max-w-2xl rounded-2xl border border-[#d9cfbf] bg-white p-6 text-center text-[#6a5848]">
          Hotel not found.
          <div className="mt-4">
            <Link href="/hotels" className="font-semibold underline">
              Back to Hotels
